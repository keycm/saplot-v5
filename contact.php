...
if (isset($_SESSION['user_id'])) {
    ...
    if (isset($_SESSION['fullname'])) {
        $full = explode(" ", $_SESSION['fullname'], 2); // split into 2 only
        $fname = $full[0];
        $lname = $full[1] ?? '';
    }
}
...
document.addEventListener("DOMContentLoaded", () => {
  <?php if(isset($_SESSION['user_id'])): ?>
    document.getElementById('fname').value = "<?php echo htmlspecialchars($fname); ?>";
    document.getElementById('lname').value = "<?php echo htmlspecialchars($lname); ?>";
